...
| Tool                          | Link                                                         |
| ----------------------------- | ------------------------------------------------------------ |
| XuanTie-compiler (Windows)    | https://occ-oss-prod.oss-cn-hangzhou.aliyuncs.com/resource//1770908312295/Xuantie-900-gcc-elf-newlib-mingw64-V3.3.0-20260204.tar.gz |
